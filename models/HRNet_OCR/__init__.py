from .hrnetocr_git_submodule.lib.models.nets.hrnet import HRNet_W48_OCR
from .hrnetocr_git_submodule.lib.utils.tools.configer import Configer
import argparse
...
def hrnet_ocr(config_path="hrnetocr_git_submodule/configs/cityscapes/H_SEGFIX.json"):
  parser = argparse.ArgumentParser()
  parser.add_argument('--configs', default=config_path, type=str,
