...
class UACANet(nn.Module):
    ...
    def __init__(self, n_channels=1, n_classes=4, channels=256, output_stride=16, pretrained=True):
        super(UACANet, self).__init__()
        self.resnet = res2net50_v1b_26w_4s(pretrained=pretrained, output_stride=output_stride, n_channels=n_channels)
        ...
        self.attention2 = UACA(channels * 2, channels, out_channels=n_classes)
